 ...
 * rota entera.
 *
 * Acá llegó tarde: catorce comandos, y en una sola tanda de cambios se sumaron
 * seis y se le cambió la firma a otros cuatro. Ninguna de esas veces hubo nada
 * que comprobara el cruce.
 *
...
function comandosDeRust(): Map<string, string[]> {
	...
	// Acá los comandos viven en un archivo solo, no en un directorio por
