...
// El i18n **no se dobla**. `tests/traducciones.test.ts` prueba el plugin de
// verdad —que el catálogo esté cargado antes de montar es justo lo que ahí se
// comprueba—, y un doble puesto desde el preload se lo lleva puesto. Sin
// catálogo su `t()` devuelve la clave, que es lo mismo que haría el doble.
